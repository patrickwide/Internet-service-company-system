...
const MessageMutation = {
    ...
    addMessage: {
        ...
        async resolve(_parent, args, context) {
            ...
            const authenticatedUser = await authenticateUser(allowedUserModels, context);
            ...
            // check ... 
            const allowedReply = getAllowReply(allowedReplyModels, args.reply);
            ...
            const message = await new Message({
                ...
                reply: allowedReply.allowedReply._id,
                reply_on_model: allowedReply.allowedReplyOnModel,
                tags: args.tags,
                body: args.body,
            }).save();
    ...
    deleteMessage: {
        ...
        async resolve(_parent, args, context) {
            ...
            return Message.findByIdAndRemove(args.id).populate("sender");
        },
    },
    // update message
    updateMessage: {
        ...
        async resolve(_parent, args, context) {
            ...
            // check ... 
            const allowedReply = allowedReplyModels(allowedReplyModels, args.reply);
...
async function getAllowReply(models, replyId) {
    for (let i = 0,allowedModelsLength = models.length; i < allowedModelsLength; i++) {
